            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <nav class="menu menu--horatio">
                    <ul class="nav navbar-nav menu__list">
                        ...
                        <li class="menu__item <?php if($_SESSION['menu_flag'] == 'myappointment'){ echo 'menu__item--current'; } ?>"><a href="my-appointment.php?flag=myappointment" class="menu__link">My Clinic Appointments</a></li> 
