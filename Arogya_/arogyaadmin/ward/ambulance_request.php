                        ...
                        <div class="col-md-8">
                            ...
                            <form class="form-horizontal" action="ambulance_request.php" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input id="datetime_need" name="datetime_need" type="datetime-local" class="form-control" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="comment" class="control-label col-xs-4">comment</label> 
                                    <div class="col-xs-8">
                                        <textarea id="comment" name="comment" cols="40" rows="5" class="form-control" required=""></textarea>
                                    </div>
                                </div> 
