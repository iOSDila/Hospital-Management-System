            ...
            <div id="content">
                ...
                <div class="blank-page-content">
                    <div class="row">
                        <div class="col-md-12">
                            <div style="width: 50%">
                                <form class="form-horizontal" action="report-doctor-salary.php" method="post">
                                    <div class="form-group">
                                        <label for="text" class="control-label col-xs-4">Doctor</label> 
                                        <div class="col-xs-8">
                                            <select class="form-control" name="doctor_id">
                                                ...
                                                if ($doctorList != null) {
                                                    foreach ($doctorList as $value) {
                                                        ?>
                                                <option value="<?= $value['id']?>"><?= $value['nic']?> - <?= $value['first_name']?> <?= $value['last_name']?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
