...
//                                    alert(first_name);
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input id="first_name" name="first_name" type="text" required="" value="Mr.Sankalpa" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="text1" class="control-label col-xs-4">Last Name <span class="mando-msg">*</span></label> 
                                    <div class="col-xs-8">
                                        <input id="last_name" name="last_name" type="text" required="" value="Amarathunga" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="text2" class="control-label col-xs-4">NIC <span class="mando-msg">*</span></label> 
                                    <div class="col-xs-8">
                                        <input id="nic" name="nic" type="number" required="" class="form-control" value="945875250" placeholder="Without V or X"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input id="text3" name="telephone" type="text" value="077 4578547" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="text4" class="control-label col-xs-4">Email <span class="mando-msg">* </span></label> 
                                    <div class="col-xs-8">
                                        <input id="text4" name="email" type="email" value="amarathunga123@gmail.com" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
