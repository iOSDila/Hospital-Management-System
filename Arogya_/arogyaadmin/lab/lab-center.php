        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="blank-page-content">
                    ...
                    VALUES ('" . $_POST['center_name'] . "','" . $_POST['Phone_Number'] . "');";
                        setData($sql, TRUE);
                    }
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <form class="form-horizontal" action="lab-center.php" method="post">
                                ...
                                <div class="form-group">
                                    <label for="text" class="control-label col-xs-4">Phone Number <span class="mando-msg">*</span></label> 
                                    <div class="col-xs-8">
                                        <input id="text"  name="Phone_Number" type="number" class="form-control">
                                    </div>
